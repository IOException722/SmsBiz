...
public class Inbox extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home_or_menu = (ImageButton) findViewById(R.id.menu_or_home);
        home_or_menu.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        {
            case R.id.createBtn:
                Intent sendMsg =  new Intent(activity, ComposeSms.class);
                sendMsg.putExtra("createmsg",true);
            ...
            case R.id.searchBtn:
                ...
                home_or_menu.setVisibility(View.VISIBLE);
                home_or_menu.setImageResource(R.drawable.ic_keyboard_backspace_black_24dp);
            ...
            case R.id.menu_or_home:
                ...
                searchedBtnClicked = false;
                searchTxt.setText("");
                searchTxt.setHint(getResources().getString(R.string.searchtext));
                smsAdapter.notifyDataSetChanged();
                smsAdapter.notifyDataSetChanged();
    ...
    public class SmsAdapter extends RecyclerView.Adapter<SmsAdapter.ViewHolder>  {
        ...
        public  class ViewHolder extends RecyclerView.ViewHolder {
            public TextView senderId,senderCount,messageDetails,timeStamp,timeDate;
            public LinearLayout lntlyt;
            public RelativeLayout singlerow;

            public ViewHolder(View v) {
                super(v);
                singlerow = (RelativeLayout) v.findViewById(R.id.singlerow);
                senderId = (TextView) v.findViewById(R.id.senderId);
                senderCount =(TextView) v.findViewById(R.id.senderCount);
                messageDetails = (TextView) v.findViewById(R.id.messageDetails);
                timeStamp = (TextView) v.findViewById(R.id.timeStamp);
                timeDate = (TextView) v.findViewById(R.id.timeDate);
                lntlyt = (LinearLayout) v.findViewById(R.id.linlyt);
            }
        }
